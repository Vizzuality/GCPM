    ...
    class MapController < ApiController
      ...
      def csv_download
        ...
        if json_list.any?
          ...
          send_data @data_to_export.to_csv.force_encoding('iso-8859-1').encode('utf-8'), type: 'text/csv; charset=utf-8; header=present', disposition: "attachment; filename=#{file_name}"
        else
