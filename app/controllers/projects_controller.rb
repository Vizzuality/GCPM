class ProjectsController < ApplicationController
  ...
  def remove_relation
    if @project.remove_relation(@user.id)
      UserMailer.user_relation_email(@user.name, @user.email, @project.title, 'removed').deliver
  ...
  def relation_request
    if @project.relation_request(@user.id)
      UserMailer.user_relation_email(@user.name, @user.email, @project.title, 'request').deliver
