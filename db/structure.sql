...
--
-- Name: index_research_units_on_address_id_and_investigator_id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_research_units_on_address_id_and_investigator_id ON research_units USING btree (address_id, investigator_id);
